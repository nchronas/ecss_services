...
f = ecss_path + "delfiPQ/ADCS/HAL/hal_uart.c"
cmd = "ln -s " + f + " " + folder
pipe = subprocess.Popen(cmd, shell=True)
pipe.wait()

f = ecss_path + "delfiPQ/ADCS/devices.c"
cmd = "ln -s " + f + " " + folder
pipe = subprocess.Popen(cmd, shell=True)
pipe.wait()

f = ecss_path + "delfiPQ/ADCS/housekeeping.c"
cmd = "ln -s " + f + " " + folder
pipe = subprocess.Popen(cmd, shell=True)
pipe.wait()

f = ecss_path + "delfiPQ/ADCS/subsystem.c"
cmd = "ln -s " + f + " " + folder
pipe = subprocess.Popen(cmd, shell=True)
pipe.wait()
...
print "Input to ccs directories"
print ecss_path + "delfiPQ/ADCS"
print ecss_path + "delfiPQ/ADCS/HAL"
print ecss_path + "delfiPQ/OSAL"
print ecss_path + "delfiPQ"
print ecss_path + "core"
print ecss_path + "services"
